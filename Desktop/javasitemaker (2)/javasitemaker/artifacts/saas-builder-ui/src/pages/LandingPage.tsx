        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10 py-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <button
              ...
              className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 text-sm text-primary font-medium mb-8 hover:bg-primary/20 hover:border-primary/40 transition cursor-pointer">
