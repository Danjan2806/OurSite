...
import {
  ...
  faArrowRight, faSliders, faBell, faEnvelope, faLock, faLockOpen,
  ...
  faPen, faPlay, faStop, faFloppyDisk,
  faArrowsUpDown, faArrowsLeftRight,
  faAlignLeft, faAlignCenter, faAlignRight,
  faEraser, faClone, faObjectGroup,
  faArrowUp, faArrowDown,
  faBorderAll, faSquare,
...
export const ArrowUpDown = makeIcon(faArrowsUpDown);
...
export const Clone = makeIcon(faClone);
export const ObjectGroup = makeIcon(faObjectGroup);
export const Grid = makeIcon(faBorderAll);
export const Square = makeIcon(faSquare);
